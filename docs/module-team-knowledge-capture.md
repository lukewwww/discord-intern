...
1. Define exact prompt templates for classification and integration
2. Implement `QACaptureHandler` following the interface from bot integration
3. Implement raw file append logic
4. Implement topic file integration with LLM
5. Build CLI regeneration command
6. Integrate with existing KB retrieval for query answering
